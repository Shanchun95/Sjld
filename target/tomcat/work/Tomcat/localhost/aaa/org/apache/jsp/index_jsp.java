 ...
 * Generated at: 2019-07-11 12:29:47 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            $.get(\"area/provinceServlet\",{},function (data) {\r\n");
      ...
      out.write("                province.append(\"<option>--请选择省份--</option>\");\r\n");
      ...
      out.write("                $.get(\"area/getCity\",{id:$(this).val()},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("\r\n");
      out.write("                    //1.获取select\r\n");
      ...
      out.write("                alert($(this).val())\r\n");
      out.write("                $.get(\"area/getCountry\",{id:$(this).val()},function (data) {\r\n");
      out.write("                    //[{\"id\":1,\"name\":\"北京\"},{\"id\":2,\"name\":\"上海\"},{\"id\":3,\"name\":\"广州\"},{\"id\":4,\"name\":\"陕西\"}]\r\n");
      out.write("\r\n");
      out.write("                    //1.获取select\r\n");
      out.write("                    var country = $(\"#country\");\r\n");
      out.write("                    country.empty();\r\n");
      out.write("                    country.append(\"<option>--请选择县--</option>\");\r\n");
      out.write("                    //2.遍历json数组\r\n");
      out.write("                    $(data).each(function () {\r\n");
      out.write("                        //3.创建<option>\r\n");
      out.write("                        var option = \"<option value='\"+this.id+\"'>\"+this.name+\"</option>\";\r\n");
